...
–card-bg: rgba(20, 25, 38, 0.8);
–card-hover: rgba(212, 175, 55, 0.05);
...
.orb-2 {
background: radial-gradient(circle, var(–accent-brass), transparent);
bottom: -200px;
right: -200px;
animation-delay: -7s;
}
...
background: linear-gradient(135deg, rgba(212, 175, 55, 0.1), rgba(201, 160, 40, 0.05));
...
background: linear-gradient(135deg, rgba(212, 175, 55, 0.15), rgba(201, 160, 40, 0.05));
border: 2px solid var(–accent-gold);
transform: scale(1.05);
}

.comparison-card:not(.featured):hover {
